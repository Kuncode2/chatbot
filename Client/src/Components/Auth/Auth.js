    ...
    <div className="loginSignup-background-container">
      <div
        className={`loginSignup-container ${
          isSignUp ? "loginSignup-right-panel-active" : ""
        }`}
      >
        <div className="loginSignup-form-container loginSignup-sign-up-container">
          <form onSubmit={handleSignup}>
            ...
            <div className="password-container">
              ...
              >
                {showPassword ? (
                  <i className="fa fa-eye-slash icon-white"></i>
                ) : (
                  <i className="fa fa-eye icon-white"></i>
                )}
              </button>
            </div>
            <div className="password-container">
        ...
        <div className="loginSignup-form-container loginSignup-sign-in-container">
          {!isForgot && (
            <form onSubmit={handleLogin}>
              ...
              <p style={{ fontSize: '12px' }}>Click for <Link to="/admin">Admin</Link> Sign in</p>
              <p
      ...
      <div className="auth-errors-container">
        ...
        {success && (
          <div className="auth-error profile-Succ-msg">{success}</div>
        )}
      </div>
    </div>
  );
